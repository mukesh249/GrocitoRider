package grocito.wingstud.groctiodriver.ui.cod
...
import grocito.wingstud.groctiodriver.databinding.FragmentCodLisfBinding
import grocito.wingstud.groctiodriver.response.CODResponse
import grocito.wingstud.groctiodriver.rest.network.RestClient
import grocito.wingstud.groctiodriver.util.FixedGridLayoutManager
...
class CodLisfFragment : Fragment() {
    ...
    val session by lazy { grocito.wingstud.groctiodriver.account.AccountManager.getUserAccount()!! }
