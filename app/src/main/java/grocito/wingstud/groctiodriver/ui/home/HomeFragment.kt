...
import grocito.wingstud.groctiodriver.databinding.OrderAlertBinding
...
class HomeFragment : Fragment(), AssignedOrderAdapter.OrderTrackListener {
    ...
    val ref = FirebaseDatabase.getInstance().getReference("grocitorider")
